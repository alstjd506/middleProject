...
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:35rem;">
      ...
      <input type="hidden" name="member_pw" value=<%= findupw %>>
      <h2 class="check" id="check">내 비밀번호 :${find }</h2><br/>
...
<!--         <button type="button"  id="btn-Yes" onclick="regist()" class="btn btn-lg btn-primary btn-block">비밀번호 재설정</button> -->
        ...
        <div class="links">
            <a href="main.do">메인으로</a> | <a href="login.do">로그인</a> | <a href="join.do">회원가입</a>
